...
WSGI_APPLICATION = 'extneg.wsgi.application'
...
JET_INDEX_DASHBOARD = 'extneg.dashboard.CustomIndexDashboard'
...
JET_SIDE_MENU_ITEMS = [  # A list of application or custom item dicts
    ...
    {'label': ('Sales'), 'items': [
        {'label': ('Orders'), 'name': 'dashboardviews.order'},
    ...
    {'label': ('Charges'), 'items': [
        {'label': ('Products'), 'name': 'dashboardviews.productcharges'},
        {'label': ('Company'), 'name': 'dashboardviews.campanycharges'},
    ]},
]
